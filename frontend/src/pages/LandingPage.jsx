...
import { Sparkles, CheckSquare, Zap, TrendingUp } from "lucide-react";
      ...
      <nav className="sticky top-0 z-50 p-4 border-b border-gray-100 backdrop-blur-md bg-white/80 transition-all duration-300">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 text-xl font-bold tracking-tight text-gray-900">
            ...
            <span className="hidden sm:inline">AI-CareerMentor</span>
          </Link>
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <section className="py-24 md:py-36 px-4 text-center">
          ...
          >
            ...
            >
              AI-CareerMentor delivers intelligent resume optimization, mock interviews, and personalized roadmaps to secure your next opportunity faster.
            </motion.p>
      ...
      <footer className="border-t border-gray-100 py-12 px-4 bg-gray-50">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} AI-CareerMentor . All rights reserved.
          </p>
        </div>
      </footer>
    </div>
