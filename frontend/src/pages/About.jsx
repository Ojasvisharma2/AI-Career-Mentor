                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-white">Ojasvi Sharma</h2>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a href="https://github.com/Ojasvisharma2" target="_blank" rel="noreferrer"
                    ...
                    >
                        ...
                        <p className="text-gray-300 leading-relaxed mb-6">
                            AICareerMentor is a comprehensive full-stack platform that leverages cutting-edge artificial intelligence to revolutionize 
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="text-center p-4 rounded-2xl bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/20">
                            ...
                            <h3 className="font-semibold text-purple-300 mb-1">AI Career Roadmap </h3>
