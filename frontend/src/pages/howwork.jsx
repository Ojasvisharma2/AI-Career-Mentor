...
const steps = [
  ...
  },
  {
    ...
    desc: "Ask career questions anytime and get instant, expert advice powered by Groq AI."
  },
  {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-fuchsia-900 text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      >
        <h1 className="text-5xl md:text-6xl font-black mb-6 bg-gradient-to-r from-fuchsia-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent animate-gradient-x">
          How AI-CareerMentor Works
        </h1>
        <p className="text-xl md:text-2xl text-fuchsia-100 mb-12 max-w-3xl mx-auto">
          AI-CareerMentor combines advanced AI (powered by Groq) and a modern, animated interface to supercharge your career journey. Here’s how you can make the most of every feature:
        </p>
        ...
        <div className="mt-16 text-fuchsia-200/80 text-lg max-w-2xl mx-auto">
          <strong>AI-CareerMentor</strong> is your all-in-one, AI-powered career companion. Whether you’re optimizing your resume, preparing for interviews, tracking jobs, or seeking advice, our platform ensures you’re always a step ahead in your professional journey.
        </div>
      </motion.div>
    </div>
  );
